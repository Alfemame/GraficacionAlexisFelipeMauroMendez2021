...
/**
 * Rectangulo3D Programa Plantilla (GLCanvas)
 */
@SuppressWarnings("serial")
public class Rectangulo3D extends GLCanvas implements GLEventListener, KeyListener  {
   ...
   public static void main(String[] args) {
      ...
      SwingUtilities.invokeLater(new Runnable() {
         ...
         public void run() {
            ...
            GLCanvas canvas = new Rectangulo3D();
