...
/**
 * TrianguloCuadrangular Programa Plantilla (GLCanvas)
 */
@SuppressWarnings("serial")
public class TrianguloCuadrangular extends GLCanvas implements GLEventListener, KeyListener  {
   ...
   public static void main(String[] args) {
      ...
      SwingUtilities.invokeLater(new Runnable() {
         ...
         public void run() {
            ...
            GLCanvas canvas = new TrianguloCuadrangular();
